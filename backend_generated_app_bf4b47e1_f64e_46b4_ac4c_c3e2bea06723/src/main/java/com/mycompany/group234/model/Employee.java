...
@Table(name = "\"Employee\"", schema =  "\"generated_app\"")
@Data
...
public class Employee {
  ...
  @Column(name = "\"EmpDomain\"", nullable = true )
  private String empDomain;
  
	  
  @Column(name = "\"EmpEmail\"", nullable = true )
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"EmpId\""),
            inverseJoinColumns = @JoinColumn( name="\"FeedbackId\""), schema = "\"generated_app\"")
